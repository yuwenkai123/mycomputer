#!/usr/bin/env python
import roslib; roslib.load_manifest('sfbot_teleop')
import rospy
...
def servoWrite(servoNum, value):
        rospy.wait_for_service('/sfbot_chassis/servo_write')
	try:
	    servo_write=rospy.ServiceProxy('/sfbot_chassis/servo_write',ServoWrite)
