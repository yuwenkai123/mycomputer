...
from std_msgs.msg import Int16,Int32, Int64, Float32, String, Header, UInt64, Float32MultiArray
...
#######################################################################################################################
		...
		self._ultrasonic_value = Float32MultiArray()
		self._qx = 0
		self._qy = 0
		self._qz = 0
		self._qw = 0
...
#Subscribers and Publishers
		...
		self._Ultrasonic_Value = rospy.Publisher('ultrasonic_distance',Float32MultiArray,queue_size = 10)
...
#######################################################################################################################
				...
				if(lineParts[0] == 'u'):
					self._ultrasonic_value.data = [float(i) for i in lineParts[1:7]]
